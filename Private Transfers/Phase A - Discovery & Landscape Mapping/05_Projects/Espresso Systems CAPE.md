...
**Proof system:** Plonk / HyperPlonk‑family zkSNARK — CAPE is built on Espresso's ZK stack; Espresso develops HyperPlonk (a Plonk‑style proof system) and positions CAPE as a smart‑contract application leveraging their ZK‑SNARK infrastructure. Exact backend may evolve, but it is Plonk‑family and Espresso‑managed rather than Groth16.
