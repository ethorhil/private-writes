...
**Proof system:** ZK‑STARK validity proofs — StarkEx is a validity‑proof‑based L2 whose core prover/verifier use STARKs; in Validium mode, data availability is off‑chain but all state transitions are enforced using ZK‑STARK proofs.
