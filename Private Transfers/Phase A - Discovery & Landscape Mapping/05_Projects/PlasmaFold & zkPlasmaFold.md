...
**Proof system:** Folding‑based zkSNARK (Nova / Vega‑style co‑SNARKs) — PlasmaFold is an experimental payment layer that combines classic Plasma with modern folding‑based ZK schemes; research notes indicate use of Nova‑style provers and Vega/co‑SNARKs rather than a single Groth16/PLONK circuit.
