...
**Proof system:** Groth16 zkSNARK — the Privacy Pools circuits are implemented in Circom and the on‑chain verifiers (`CommitmentVerifier`, `WithdrawalVerifier`, etc.) use Groth16 verification; the Ekubo reference repo shows Groth16 setup and verifier generation.
