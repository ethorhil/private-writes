...
**Proof system:** Boojum (ZKSync's STARK‑based, PLONK‑style system) — Prividium is built on the ZKSync stack; zkSync Era and ZK Stack use the Boojum proof system, a STARK‑based prover with PLONK‑type arithmetization and SNARK (Plonk/Fflonk) wrappers for L1 verification.
