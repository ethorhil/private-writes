...
**Proof system:** Groth16 zkSNARK — zkBob's docs and comparisons with Railgun state that both systems use Groth16; zkBob's own implementation and verifier contracts are described as Groth16‑based zkSNARKs for its stablecoin shielded pool.
