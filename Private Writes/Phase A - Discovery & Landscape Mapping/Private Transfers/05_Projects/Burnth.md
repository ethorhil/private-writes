...
**Proof system:** Groth16 zkSNARK — the Burnth reference implementation for EIP‑7503 uses Circom circuits and snarkjs, generating Groth16 proofs for the proof‑of‑burn and transfer circuits.
