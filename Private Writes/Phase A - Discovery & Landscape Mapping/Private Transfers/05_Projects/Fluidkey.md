...
**Proof system:** None — Fluidkey provides private accounts/payments via stealth addresses and key‑management on Ethereum (ephemeral keys, view keys, etc.), not via zkSNARK/zkSTARK proof systems.
